...
#  Default: 'vincentclemson'
# c.Session.username = 'vincentclemson'
...
#  Choices: any of ['sha3_224', 'sha384', 'blake2b', 'sha1', 'md5', 'blake2s', 'sha224', 'sha3_256', 'sha3_512', 'sha512', 'sha256', 'sha3_384']
#  Default: 'sha256'
